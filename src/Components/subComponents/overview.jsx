...
class OverView extends Component {
	...
	render() {
		return (
            ...
            <div className="col-lg-2 col-md-2 col-sm-2 col-xs-2 blueDivOverview text-center "><span className=""> &#60;</span></div>
            ...
            <div className="col-lg-2 col-md-2 col-sm-2 col-xs-2 blueDivOverview text-center "><span>&#62;</span></div>
